...
export default function GalleryPage() {
  ...
  const [preview, setPreview] = useState<Asset | null>(null); // lightbox
        ...
        <header className="flex flex-wrap items-center justify-between gap-4">
          <div>
            ...
            <p className="mt-1 text-sm text-white/50">
              Your images — uploads and generated outputs. Click any image to view it.
              Pick from here directly in Workflows and Agent chat.
            </p>
          </div>
