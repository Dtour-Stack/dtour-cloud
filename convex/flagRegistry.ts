...
export const FLAG_REGISTRY: readonly FlagDef[] = [
  ...
  },
  {
    ...
    defaultEnabled: true,
    label: "API keys",
    description: "Programmatic access key creation, one-time reveal, and revocation.",
    routes: ["/api-keys"],
    status: "live",
  },
  {
    ...
    defaultEnabled: true,
    label: "MCP servers",
    description: "MCP catalog and saved tool-server connections for agent wiring.",
    routes: ["/mcps"],
    status: "beta",
  },
  {
    ...
    defaultEnabled: true,
    label: "App Builder",
    description: "Prompt-to-app builder backed by agents, infra, APIs, MCPs, databases, designs, and knowledge.",
    routes: ["/apps"],
    status: "beta",
  },
  {
    ...
    defaultEnabled: true,
    label: "Instances",
    description: "Remote agent runtime, endpoint, mesh, and domain controls.",
    routes: ["/instances"],
    status: "beta",
  },
  {
